...
public class Parameters {
    ...
    public void changeParameters() {  // изменения параметров симуляции
        changeIslandSize();
    ...
    private void changeIslandSize() {  // изменения размера острова
        System.out.println("Хотите ли вы изменить размер острова (100x20)?");
    ...
    private int changePredatorsSize() { // изменения количества хищников
    ...
    private int changeHerbivoresSize() { // изменения количества травоядных
    ...
    private int changePlantsSize() { // изменения количества растений
